// Adapted from shadcn shader-animation for Vite + React (no "use client").
// Fills its parent (h-full) instead of h-screen so it can be used as a section
// background. Caps pixel ratio for performance.
